...
public class A21 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        HandlerMethod handlerMethod = new HandlerMethod(new Controller(), Controller.class.getMethod("test", String.class, String.class, Integer.class, String.class, MultipartFile.class, Integer.class, String.class, String.class, String.class, HttpServletRequest.class, User.class, User.class, User.class));
        ...
        for (MethodParameter parameter : handlerMethod.getMethodParameters()) {
            ...
            composite.addResolvers(
                    ...
                    new ServletModelAttributeMethodProcessor(false), //false: 必须有@ModelAttribute
    ...
    static class Controller {
        public void test(
                ...
                @RequestParam("age") Integer age,        // age=18
                ...
                @Value("${java.home}") String home2, // spring 获取数据  ${} #{}
